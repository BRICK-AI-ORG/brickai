export const labels = [
  ...
  },
  {
    ...
    "text-color": "text-fuchsia-800",
    "border-color": "border-fuchsia-300",
  },
  {
    value: "legal",
    label: "Legal",
...
export const getLabelColors = (label: string) => {
  const labelObj = labels.find((entry) => entry.value === label);
  return {
